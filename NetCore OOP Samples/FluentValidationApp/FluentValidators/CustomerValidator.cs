...
namespace FluentValidationApp.FluentValidators
{
    public class CustomerValidator : AbstractValidator<Customer>
    {
        ...
        public string AgeMessage { get; } = "{PropertyName} must be between {PropertyValue} and {PropertyValue}";
        ...
        public CustomerValidator()
        {
            ...
            RuleFor(property => property.Age).NotEmpty().WithMessage("Age can not be empty...").InclusiveBetween(18, 120).WithMessage(AgeMessage);
